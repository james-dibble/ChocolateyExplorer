...
// Original file name:
// Generation date: 27/09/2014 15:27:08
namespace Chocolatey.OData.Nuget
{
    ...
    public partial class PackageContext : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            global::System.Type resolvedType = this.DefaultResolveType(typeName, "NuGet.Server.DataServices", "Chocolatey.OData.Nuget");
        ...
        {
            if (clientType.Namespace.Equals("Chocolatey.OData.Nuget", global::System.StringComparison.Ordinal))
            {
